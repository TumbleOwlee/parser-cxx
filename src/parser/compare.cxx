...
template <typename T, typename S> struct Context {
  static inline auto eval(T const &left,
...
auto ::parse::compare::eval(::parse::Value const &left,
                            ::parse::compare::Comparison op,
